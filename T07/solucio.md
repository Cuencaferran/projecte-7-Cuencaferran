...
### 1. 🔍 Anàlisi d'Alternatives (Estudi de Mercat)

Per modernitzar la comunicació de **FoodLogistic**, hem analitzat quatre de les plataformes més potents del mercat. Totes elles permeten anar més enllà del simple correu, oferint un espai de treball compartit al núvol:

* **🌐 Google Workspace (Pla Business Standard):** La solució de Google. Destaca per ser molt intuïtiva (Gmail i Drive). Tot es gestiona directament des del navegador d'Internet.
* **💻 Microsoft 365 (Pla Business Standard):** L'opció de Microsoft. Ideal per a empreses acostumades a les aplicacions clàssiques com **Word** o **Excel** instal·lades a l'ordinador.
* **💼 Zoho Workplace (Pla Professional):** Una alternativa potent i més econòmica. Ofereix un ecosistema propi de correu i documents sense dependre dels gegants habituals.
* **🚀 Lark Suite (Pla Pro):** Una plataforma emergent que integra en una sola aplicació el xat, les videotrucades i la gestió de tasques de manera molt moderna.

---

### 2. 📊 Comparativa de Característiques

Comparem els punts clau dels tres candidats principals per als **35 treballadors** de l'empresa:

| Característica | **Google Workspace (Standard)** | **Microsoft 365 Standard** | **Zoho Workplace** |
| :--- | :--- | :--- | :--- |
| 💶 **Cost mensual/usuari** | 11,50 € | 11,70 € | **6,00 €** |
| 📅 **Cost anual (35 usuaris)** | 4.830 € | 4.914 € | **2.520 €** |
| 💾 **Emmagatzematge** | **2 TB per usuari** | 50 GB correu + 1 TB núvol | 100 GB correu + 100 GB núvol |
| 🛡️ **Seguretat** | Filtre spam, xifrat i 2FA (mòbil) | Antivirus avançat, anti-phishing i MFA | Xifrat, gestor de contrasenyes i MFA |
| 🤝 **Eines col·laboració** | Meet, Drive, Docs, Xat | Teams, OneDrive, Word, Excel | Cliq, Meeting, Writer, Sheet |
